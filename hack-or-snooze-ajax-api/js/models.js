...
class Story {
  ...
  getHostName() {
    ...
    let hostname = str;
    if (strIndex > 0){
      hostname = str.substring(0, strIndex);
    }
...
class StoryList {
  ...
  async addStory(  user, story ) {
    ...
    //creates new story from response, which is added to storylist
...
class User {
  ...
  //Using the story id, calls api to post a new user favorited story
  //Returns a list of the users favorite stories
  ...
  //Using the story id, calls api to delete a previosly favorited story
  //Returns a list of the users favorite stories
  ...
  //calls api to delete a story that the user posted from the api's stories list
